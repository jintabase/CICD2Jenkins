...
var serverSet = wire.NewSet(
	...
	provideAuthLogic, logic.NewArticleLogic, service.NewAuthService, service.NewArticleService, middleware.NewAuthMiddleware, httpapi.NewRouter, provideHTTPServer,
)
